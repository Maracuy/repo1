...
<body>
    ...
    <?php
        ...
        include_once('programas/solicitudNueva.php');
   ...
   <!-- <script type="text/javascript" src="programas/indiceProgramas.js"></script> -->
    <script type="text/javascript" src="programas/funciones.js"></script>
    <!--<script src="https://code.jquery.com/jquery-3.5.1.min.js"></script>-->
